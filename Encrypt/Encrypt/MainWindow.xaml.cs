    ...
    public partial class MainWindow : Window
    {
        ...
        public void register(string saltValue, string username, string password)
        {
            try
            {
                ...
                {
                    // Password already exists, show error message
                    RegisterError.Visibility = Visibility.Visible;
                    RegisterError.Foreground = System.Windows.Media.Brushes.Red;
                    RegisterError.Text = "This username is too short";
                    return;
                }
                if (password.Length < 8)
                {
                    ...
                    RegisterError.Visibility = Visibility.Visible;
                    RegisterError.Foreground = System.Windows.Media.Brushes.Red;
                    RegisterError.Text = "This password is too short";
                    return;
                }
                // Check if the password contains at least one capital letter and one number
                if (!Regex.IsMatch(password, "[A-Z]"))
                {
                    // Password does not meet complexity requirements, show error message
                    RegisterError.Visibility = Visibility.Visible;
                    RegisterError.Foreground = System.Windows.Media.Brushes.Red;
                    RegisterError.Text = "Password must contain at least one capital letter";
                    return;
                }
                if (!Regex.IsMatch(password, "[0-9]"))
                {
                    ...
                    RegisterError.Visibility = Visibility.Visible;
                    RegisterError.Foreground = System.Windows.Media.Brushes.Red;
                    RegisterError.Text = "Password must contain at least one number";
                    return;
                }
